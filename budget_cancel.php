...
<body>
  ...
  <div class="col-sm-10">
	  ...
	  <h3 class="text-center text-dark"><b style="background-color:#F0E68C">Budget Cancel</b></h3>
    <hr>
<?php
	...
	if(isset($_GET['budget_id'])) 
	{
		...
		$sql = "update budget set approve_status = 0 WHERE budget_id='$budget_id'";
		$conn->query($sql);
		...
		$sql = "SELECT * FROM budget where approve_status = 1";
		$rec = $conn->query($sql);
			...
			while($row = mysqli_fetch_array($rec))
			{
				...
				echo "<tr bgcolor='#F4F4F4'>
					...
					<td>
						<a href='$_SERVER[SCRIPT_NAME]?budget_id=$budget_id' class='button1'>Cancel</a>
					</td>
				</tr>";
			}
