...
<body>
<div class="col-sm-10">
      <div class="well"style="background-color:#87CEFA; height:250%;"> </br>
	  <h3 class="text-center text-dark" ><b style="background-color:#F0E68C" >Budget Report</b></h3>
    <hr>
...
if(isset($_POST['generate_report'])) {
	...
	$sql .= " budget_entry_date between '$from_date' and '$to_date'";
	...
	echo "<tr bgcolor='#F0E68C' style='height:30px; font-weight:bold;'>
		...
		<td style='width:120px; text-align:center'>Batch Name</td>
		<td style='width:200px; text-align:center'>Budget Date</td>
		<td style='width:150px; text-align:center'>No Of Days</td>
		<td style='width:120px; text-align:center'>Budget Amount</td>
		<td style='width:120px; text-align:center'>Approval Status</td>
	</tr>";
...
<div class="card text-center  bg-success" style="margin-top:30%;">
